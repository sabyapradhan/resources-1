...
| Knowledge Catalog | 米国南部でホスト | 英国でホスト | ドイツでホスト | 使用不可 | 使用不可 | 使用不可 | 
...
| ツールチェーン | 米国南部でホスト | 英国でホスト | ドイツでホスト | 使用不可 | 米国東部でホスト | 使用不可 | 
...
| Watson Studio | 米国南部でホスト | 英国でホスト | ドイツでホスト | 使用不可 | 使用不可 | 使用不可 | 
