...
| Databases for Elasticsearch | ダラスでホスト | 使用不可 | フランクフルトでホスト | シドニーでホスト | 使用不可 | 東京でホスト | 
| Databases for Etcd | ダラスでホスト | 使用不可 | フランクフルトでホスト | シドニーでホスト | 使用不可 | 東京でホスト | 
| Databases for PostgreSQL | ダラスでホスト | 使用不可 | フランクフルトでホスト | シドニーでホスト | 使用不可 | 東京でホスト | 
| Databases for Redis | ダラスでホスト | 使用不可 | フランクフルトでホスト | シドニーでホスト | 使用不可 | 東京でホスト | 
...
| MQ | ダラスでホスト | ロンドンでホスト | 使用不可 | シドニーでホスト | 使用不可 | 使用不可 | 
...
| Messages for RabbitMQ | ダラスでホスト | 使用不可 | フランクフルトでホスト | シドニーでホスト | 使用不可 | 東京でホスト | 
