...
다음의 각 유스 케이스에 대해 동일한 레벨의 액세스 권한을 부여하고자 하는 사용자 그룹이 있는 경우, 해당 사용자를 [액세스 그룹](/docs/iam/groups.html#groups)에 추가하십시오. 액세스 그룹을 사용하면 액세스 그룹 내의 모든 구성원이 그룹에 지정된 모든 액세스 권한을 상속하므로 최소 수의 액세스 정책을 사용할 수 있습니다.
{: tip}
