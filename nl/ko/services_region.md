...
| Databases for Elasticsearch | 댈러스에서 호스팅됨 |사용할 수 없음 | 프랑크푸르트에서 호스팅됨 |시드니에서 호스팅됨 |사용할 수 없음 | 도쿄에서 호스팅됨 | 
| Databases for Etcd | 댈러스에서 호스팅됨 |사용할 수 없음 | 프랑크푸르트에서 호스팅됨 |시드니에서 호스팅됨 |사용할 수 없음 | 도쿄에서 호스팅됨 | 
|Databases for PostgreSQL | 댈러스에서 호스팅됨 |사용할 수 없음 | 프랑크푸르트에서 호스팅됨 |시드니에서 호스팅됨 |사용할 수 없음 | 도쿄에서 호스팅됨 | 
|Databases for Redis | 댈러스에서 호스팅됨 |사용할 수 없음 | 프랑크푸르트에서 호스팅됨 |시드니에서 호스팅됨 |사용할 수 없음 | 도쿄에서 호스팅됨 | 
...
| Messages for RabbitMQ | 댈러스에서 호스팅됨 |사용할 수 없음 | 프랑크푸르트에서 호스팅됨 |시드니에서 호스팅됨 |사용할 수 없음 | 도쿄에서 호스팅됨 | 
