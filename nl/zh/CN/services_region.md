...
| Databases for Elasticsearch | 在达拉斯托管 |不可用| 在法兰克福托管 |在悉尼托管|不可用| 在东京托管 | 
| Databases for Etcd | 在达拉斯托管 |不可用| 在法兰克福托管 |在悉尼托管|不可用| 在东京托管 | 
|Databases for PostgreSQL| 在达拉斯托管 |不可用| 在法兰克福托管 |在悉尼托管|不可用| 在东京托管 | 
|Databases for Redis| 在达拉斯托管 |不可用| 在法兰克福托管 |在悉尼托管|不可用| 在东京托管 | 
