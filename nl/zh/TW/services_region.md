...
|App ID |在達拉斯進行管理|不適用 | 
|App Launch |在達拉斯進行管理|不適用 | 
|Auto-Scaling|在達拉斯進行管理|在華盛頓特區進行管理| 
...
|Cloudant |在達拉斯進行管理|在華盛頓特區進行管理| 
|Compare and Comply |在達拉斯進行管理|在華盛頓特區進行管理| 
|Compose Enterprise|在達拉斯進行管理|在華盛頓特區進行管理| 
|Compose for Elasticsearch|在達拉斯進行管理|在華盛頓特區進行管理| 
|Compose for JanusGraph|在達拉斯進行管理|在華盛頓特區進行管理| 
|Compose for MongoDB|在達拉斯進行管理|在華盛頓特區進行管理| 
|Compose for MySQL|在達拉斯進行管理|在華盛頓特區進行管理| 
|Compose for PostgreSQL|在達拉斯進行管理|在華盛頓特區進行管理| 
|Compose for RabbitMQ|在達拉斯進行管理|在華盛頓特區進行管理| 
|Compose for Redis|在達拉斯進行管理|在華盛頓特區進行管理| 
...
|Internet Services |在全球管理|在全球管理| 
|Internet of Things Platform |在達拉斯進行管理|不適用 | 
|Investment Portfolio |在達拉斯進行管理|不適用 | 
...
|Natural Language Understanding|在達拉斯進行管理|在華盛頓特區進行管理| 
...
|Speech to Text|在達拉斯進行管理|在華盛頓特區進行管理| 
|Streaming Analytics |在達拉斯進行管理|在華盛頓特區進行管理| 
|Text to Speech|在達拉斯進行管理|在華盛頓特區進行管理| 
...
|Watson OpenScale |在達拉斯進行管理|不適用 | 
|Watson Studio |在達拉斯進行管理|不適用 | 
|Weather Company Data|在達拉斯進行管理|不適用 | 
|WebSphere Application Server |在達拉斯進行管理|不適用 | 
{: caption="表 1. 服務可用性 - 美洲" caption-side="top"}
{: #paas-table1}
{: tab-title="Americas"}
{: tab-group="PaaS"}
...
|App ID |在倫敦進行管理|在法蘭克福進行管理| 
|App Launch |不適用 |不適用 | 
|Auto-Scaling|在倫敦進行管理|在法蘭克福進行管理| 
...
|Cloud Object Storage |在全球管理|在全球管理| 
|Cloudant |在倫敦進行管理|在法蘭克福進行管理| 
|Compare and Comply |不適用 |在法蘭克福進行管理| 
|Compose Enterprise|在倫敦進行管理|在法蘭克福進行管理| 
|Compose for Elasticsearch|在倫敦進行管理|在法蘭克福進行管理| 
|Compose for JanusGraph|在倫敦進行管理|在法蘭克福進行管理| 
|Compose for MongoDB|在倫敦進行管理|在法蘭克福進行管理| 
|Compose for MySQL|在倫敦進行管理|在法蘭克福進行管理| 
|Compose for PostgreSQL|在倫敦進行管理|在法蘭克福進行管理| 
|Compose for RabbitMQ|在倫敦進行管理|在法蘭克福進行管理| 
|Compose for Redis|在倫敦進行管理|在法蘭克福進行管理| 
...
|Internet Services |在全球管理|在全球管理| 
|Internet of Things Platform |在倫敦進行管理|在法蘭克福進行管理| 
|Investment Portfolio |不適用 |不適用 | 
...
|Natural Language Understanding|在倫敦進行管理|在法蘭克福進行管理| 
...
|Speech to Text|在倫敦進行管理|在法蘭克福進行管理| 
|Streaming Analytics |在倫敦進行管理|在法蘭克福進行管理| 
|Text to Speech|在倫敦進行管理|在法蘭克福進行管理| 
...
|Watson OpenScale |不適用 |不適用 | 
|Watson Studio |在倫敦進行管理|在法蘭克福進行管理| 
|Weather Company Data|在倫敦進行管理|不適用 | 
|WebSphere Application Server |在倫敦進行管理|在法蘭克福進行管理| 
{: caption="表 2. 服務可用性 - 歐洲" caption-side="top"}
{: #paas-table2}
{: tab-title="Europe"}
{: tab-group="PaaS"}
{: class="simple-tab-table"}
...
|App ID |在雪梨進行管理|在東京進行管理| 
|App Launch |不適用 |不適用 | 
|Auto-Scaling|在雪梨進行管理|不適用 | 
...
|Cloud Foundry Enterprise Environment|不適用 |不適用 | 
|Cloud Object Storage |在全球管理|在全球管理| 
|Cloudant |在雪梨進行管理|在東京進行管理| 
|Compare and Comply |不適用 |不適用 | 
|Compose Enterprise|在雪梨進行管理|不適用 | 
|Compose for Elasticsearch|在雪梨進行管理|不適用 | 
|Compose for JanusGraph|在雪梨進行管理|不適用 | 
|Compose for MongoDB|在雪梨進行管理|不適用 | 
|Compose for MySQL|在雪梨進行管理|不適用 | 
|Compose for PostgreSQL|在雪梨進行管理|不適用 | 
|Compose for RabbitMQ|在雪梨進行管理|不適用 | 
|Compose for Redis|在雪梨進行管理|不適用 | 
...
|Instrument Analytics |不適用 |不適用 | 
|Internet Services |在全球管理|在全球管理| 
|Internet of Things Platform |不適用 |不適用 | 
|Investment Portfolio |不適用 |不適用 | 
...
|Natural Language Understanding|在雪梨進行管理|在東京進行管理| 
...
|Simulated Instrument Analytics |不適用 |不適用 | 
|Simulated Instruments Analytics API |不適用 |不適用 | 
|Speech to Text|在雪梨進行管理|在東京進行管理| 
|Streaming Analytics |不適用 |不適用 | 
|Text to Speech|在雪梨進行管理|在東京進行管理| 
...
|Watson OpenScale |不適用 |不適用 | 
|Watson Studio |不適用 |在東京進行管理| 
|Weather Company Data|在雪梨進行管理|不適用 | 
|WebSphere Application Server |在雪梨進行管理|不適用 | 
{: caption="表 3. 服務可用性 - 亞太地區" caption-side="top"}
{: #paas-table3}
