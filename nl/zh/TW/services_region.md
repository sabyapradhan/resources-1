...
在全球管理的服務會建立跨越多個地區運作的資源。例如，使用 {{site.data.keyword.cos_full_notm}} (COS)，您可以選擇將資料分散在單一資料中心、整個地區，或甚至是藉由[選取應用程式傳送 REST API 要求的端點](https://console.bluemix.net/docs/services/cloud-object-storage/basics/endpoints.html#select-regions-and-endpoints)而分散在某個地區組合。
...
|服務|美國南部|英國|德國|雪梨|美國東部|
|-----|-----|-----|-----|-----|-----|
|API Connect|在美國南部進行管理|在英國進行管理|在德國進行管理|在雪梨進行管理|在美國東部進行管理| 
|Activity Tracker |在美國南部進行管理|在英國進行管理|在德國進行管理|在雪梨進行管理|不適用 | 
|Alert Notification|在美國南部進行管理|在英國進行管理|不適用 |在雪梨進行管理|不適用 | 
|Analytics Engine |在美國南部進行管理|在英國進行管理|不適用 |不適用 |不適用 | 
|Apache Spark|在美國南部進行管理|在英國進行管理|不適用 |不適用 |不適用 | 
|App Connect|在美國南部進行管理|在英國進行管理|不適用 | 從美國南部進行聯合發佈|不適用 | 
|App ID |在美國南部進行管理|在英國進行管理|在德國進行管理|在雪梨進行管理|不適用 | 
|App Launch |在美國南部進行管理|不適用 |不適用 |不適用 |不適用 | 
|Auto-Scaling|在美國南部進行管理|在英國進行管理|在德國進行管理|在雪梨進行管理|在美國東部進行管理| 
|Automated Accessibility Tester|在美國南部進行管理|在英國進行管理|不適用 |從英國進行聯合發佈|不適用 | 
...
|Compose for MongoDB|在美國南部進行管理|在英國進行管理|在德國進行管理|在雪梨進行管理|在美國東部進行管理| 
|Compose for MySQL|在美國南部進行管理|在英國進行管理|在德國進行管理|在雪梨進行管理|在美國東部進行管理| 
|Compose for PostgreSQL|在美國南部進行管理|在英國進行管理|在德國進行管理|在雪梨進行管理|在美國東部進行管理| 
|Compose for RabbitMQ|在美國南部進行管理|在英國進行管理|在德國進行管理|在雪梨進行管理|在美國東部進行管理| 
|Compose for Redis|在美國南部進行管理|在英國進行管理|在德國進行管理|在雪梨進行管理|在美國東部進行管理| 
...
|Decision Optimization|在美國南部進行管理|在英國進行管理|不適用 |不適用 |不適用 | 
...
|Historical Instrument Analytics |在美國南部進行管理|不適用 |不適用 |不適用 |不適用 | 
|Hyper Protect Crypto Services |在美國南部進行管理|不適用 |不適用 |不適用 |不適用 | 
|Hyper Protect DBaaS |在美國南部進行管理|在英國進行管理|不適用 |不適用 |不適用 | 
|IBM Cloud Functions|在美國南部進行管理|在英國進行管理|在德國進行管理|不適用 |在美國東部進行管理| 
...
|Internet of Things Platform |在美國南部進行管理|在英國進行管理|在德國進行管理|不適用 |不適用 | 
|Investment Portfolio |在美國南部進行管理|不適用 |不適用 |不適用 |不適用 | 
|Key Protect |在美國南部進行管理|在英國進行管理|在德國進行管理|在雪梨進行管理|不適用 | 
|Knowledge Catalog |在美國南部進行管理|在英國進行管理|不適用 |不適用 |不適用 | 
|Knowledge Studio |在美國南部進行管理|不適用 |在德國進行管理|在雪梨進行管理|在美國東部進行管理| 
|Language Translator|在美國南部進行管理| 從美國南部進行聯合發佈|在德國進行管理|在雪梨進行管理|在美國東部進行管理| 
|Lift CLI |在美國南部進行管理|不適用 |不適用 |不適用 |不適用 | 
|Log Analysis |在美國南部進行管理|在英國進行管理|在德國進行管理|在雪梨進行管理|不適用 | 
|MQ |在美國南部進行管理|在英國進行管理|不適用 |不適用 |不適用 | 
|Machine Learning |在美國南部進行管理|在英國進行管理|不適用 |不適用 |不適用 | 
|Master Data Management |在美國南部進行管理|在英國進行管理|在德國進行管理|在雪梨進行管理|不適用 | 
|Message Hub|在美國南部進行管理|在英國進行管理|在德國進行管理|在雪梨進行管理|不適用 | 
...
|Natural Language Understanding|在美國南部進行管理| 從美國南部進行聯合發佈|在德國進行管理|在雪梨進行管理|在美國東部進行管理| 
|Object Storage OpenStack Swift |在美國南部進行管理|在英國進行管理|不適用 |不適用 |不適用 | 
|Personality Insights|在美國南部進行管理| 從美國南部進行聯合發佈|在德國進行管理|在雪梨進行管理|在美國東部進行管理| 
|Portfolio Optimization |在美國南部進行管理|不適用 |不適用 |不適用 |不適用 | 
...
| VMware Solutions |在全球管理|在全球管理|在全球管理|在全球管理|在全球管理| 
